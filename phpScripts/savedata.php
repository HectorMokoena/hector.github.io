...
update($email, $dob, $gender, $nationality, $animal, $conn);
...
function update($email, $dob, $gender, $nationality, $animal, $conn){

    
$sql = "UPDATE contactform SET dateofbirth='$dob', gender='$gender', nationality='$nationality', animal='$animal' WHERE email='$email'";
